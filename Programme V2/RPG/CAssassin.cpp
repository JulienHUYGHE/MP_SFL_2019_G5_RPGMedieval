...
CAssassin::CAssassin(string nom, int maxpdv, int esquive, int vitesse, int atk, int def, int agi, int intel)
{
    m_nom = nom;
...
CAssassin::CAssassin(CPersonnage * personnage1)
{
...
void CAssassin::Set_Invis(int nbtour)
{
    m_NbInvis = nbtour;
    cout << m_nom << "est invisible pour " << nbtour << " tours.";
}

int CAssassin::Get_Invis()
{
    return m_NbInvis;
}
